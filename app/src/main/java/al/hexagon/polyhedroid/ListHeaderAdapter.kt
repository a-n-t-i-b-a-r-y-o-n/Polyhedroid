...
// TODO: Rename this to something that reflects that it is an adapter for TaskLists (creates expandable list objects)
class ListHeaderAdapter(var context: Context, var items: ArrayList<TaskList>, private var expandMgr: RecyclerViewExpandableItemManager) : AbstractExpandableItemAdapter<ListHeaderAdapter.GroupViewHolder, ListHeaderAdapter.ChildViewHolder>() {
